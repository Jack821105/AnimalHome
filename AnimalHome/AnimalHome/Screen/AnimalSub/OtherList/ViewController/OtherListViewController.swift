...
extension OtherListViewController: StoryboardInstantiable {}
...
class OtherListViewController: UIViewController {
    ...
    private lazy var viewModel: OtherListViewModel = {
        let model = OtherListViewModel()
        model.delegate = self
        return model
    }()
...
extension OtherListViewController: UITableViewDelegate {
...
extension OtherListViewController: UITableViewDataSource {
...
extension OtherListViewController: OtherListViewModelDelegate {
    func updateInfo() {
